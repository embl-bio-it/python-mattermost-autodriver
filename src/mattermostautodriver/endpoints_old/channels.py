...
class Channels(Base):
    ...
    def get_managed_categories(self, team_id):
    ...
    def set_channel_members(self, channel_id, options):
        """Set channel members
        ...
        """
        return self.client.put(f"/api/v4/channels/{channel_id}/members", options=options)
